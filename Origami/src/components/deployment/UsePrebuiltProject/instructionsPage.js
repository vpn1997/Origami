          ...
          <div style={styles.contentDiv}>
            ...
            <div >
              ...
              <div
                ...
                <h1 style={{fontSize:'22px',color:'##606470',fontWeight:'600',paddingTop:'30px',paddingLeft:'30px'}}> You're Almost There </h1>
                <div style={{paddingLeft:'7%',paddingTop:'10px',fontSize:'15px',color:'##606470'}}>
                <div className="row" >
                1. Download the bundled Code.
                </div>
                <div className="row" style={{paddingTop:'10px'}}>
                2. Configure your Machine learning code with the bundle .<text style={{color:'#00c8f8',paddingRight:'5px'}}>Read the docs</text> 	for bundling instructions .
                </div>
                <div className="row" style={{paddingTop:'10px'}} >
               ...
               <div className="two column row" style={{paddingTop:'30px',marginLeft:'7%'}} >
               <div className="column">
                 
                  <Button primary   style={styles.down}  >
                        <text style={styles.txt}>
                        Download
                        <span><a style={styles.logo}><img src={require('../../assets/download.png')}/></a></span>
                        </text>
                  </Button>
                 ...
                 <Button primary  style={styles.down3}  >
                        <text style={styles.txt}>
                        Upload
                        <span><a style={styles.logo}><img src={require('../../assets/upload.png')}/></a></span>
                        </text>
                  </Button>
                  <div  style={styles.down4}  />
                       ...
                       <div >
                       <img src={require('../../assets/backward.png')} onClick={this.back.bind(this)} style={{height:'49px',width:'49px'}} />
                       </div>
                       </div>
                       <div className="column" style={{marginLeft:"14%"}}>
                       <div >
                       <img src={require('../../assets/forward.png')} style={{height:'49px',width:'49px'}} />
                       </div>
                       </div>
                       </div>
                       <div className="two column row">
                       <div className="column" style={{marginLeft:"33%",paddingTop:'10px'}}>
                       <div style={{fontSize:'18px',color:'#323643'}}>
                       Register Page
                       </div>
                       </div>
                       <div className="column" style={{marginLeft:"8%",paddingTop:'10px'}}>
                       <div style={{fontSize:'18px',color:'#323643'}}>
                       Demo Page
                       </div>
                       </div>
